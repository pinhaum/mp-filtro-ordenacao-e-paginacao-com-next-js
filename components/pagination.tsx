      ...
      <PaginationContent>
        <PaginationItem
          className={`${
            links[0].url
              ? "cursor-pointer"
              : "cursor-auto text-slate-300 disabled:pointer-events-none disabled:cursor-default"
          }`}
          onClick={() =>
        ...
        {links.map((link) => {
          ...
          return (
            <PaginationItem
              key={link.id}
              className="hidden md:inline-flex cursor-pointer disabled:pointer-events-none disabled:cursor-default"
            >
              <PaginationLink
